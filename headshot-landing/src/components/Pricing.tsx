...
const PLANS = [
  {
    name: "Standard",
    price: "5",
    description: "Perfect for your first run &mdash; pick any 3 portrait themes.",
    features: [
      "Upload 3&ndash;10 selfies",
      "Choose any 3 portrait themes",
      "Multiple retouched portraits per theme",
      "2 free revisions",
      "ID photo style included",
      "Same-day delivery",
    ],
    cta: "Choose Standard",
    featured: false,
  },
  {
    name: "Pro",
    price: "10",
    description: "Every theme, unlimited shoots &mdash; until you love them.",
    features: [
      "Unlimited selfie uploads",
      "All 9 portrait themes, shoot freely",
      "Multiple retouched portraits per theme",
      "3 free revisions",
